...
## Project Description
DineOut is an **Android based Restaurant Management System** that aims to digitalize the process of various restaurant operations including **ordering, dishes, hall and inventory management**. 
...
***For complete details regarding the Functional and Non-Functional Requirements you can refer to the detailed [Software Requirements Specification document](../master/documents/SRS(Latest).pdf).***
